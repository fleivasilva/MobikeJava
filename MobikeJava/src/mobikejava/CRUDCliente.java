...
public class CRUDCliente extends JPanel {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${medioPago}"));
        columnBinding.setColumnName("Medio Pago");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${numeroCelular}"));
        columnBinding.setColumnName("Numero Celular");
        columnBinding.setColumnClass(String.class);
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${selectedElement.arriendoCollection}");
        jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, eLProperty, detailTable);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${idArriendo}"));
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                CRUDCliente.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                CRUDCliente.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                CRUDCliente.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                CRUDCliente.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                CRUDCliente.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                CRUDCliente.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        mobikejava.Cliente c = list.get(masterTable.convertRowIndexToModel(index));
        Collection<mobikejava.Arriendo> as = c.getArriendoCollection();
        int[] selected = detailTable.getSelectedRows();
        List<mobikejava.Arriendo> toRemove = new ArrayList<mobikejava.Arriendo>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);
            int count = 0;
            Iterator<mobikejava.Arriendo> iter = as.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            mobikejava.Arriendo a = iter.next();
            toRemove.add(a);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<mobikejava.Arriendo> as = c.getArriendoCollection();
        if (as == null) {
            as = new LinkedList<mobikejava.Arriendo>();
            c.setArriendoCollection((List) as);
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<mobikejava.Cliente> toRemove = new ArrayList<mobikejava.Cliente>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            mobikejava.Cliente c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        mobikejava.Cliente c = new mobikejava.Cliente();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<mobikejava.Cliente> merged = new ArrayList<mobikejava.Cliente>(list.size());
            for (mobikejava.Cliente c : list) {
    ...
    private java.util.List<mobikejava.Cliente> list;
